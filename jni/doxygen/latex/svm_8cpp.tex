\hypertarget{svm_8cpp}{\section{/\-Users/rcjohnson/\-Documents/\-Securics/squirrel\-\_\-pipeline/jni/onevset\-S\-V\-M/svm.cpp File Reference}
\label{svm_8cpp}\index{/\-Users/rcjohnson/\-Documents/\-Securics/squirrel\-\_\-pipeline/jni/onevset\-S\-V\-M/svm.\-cpp@{/\-Users/rcjohnson/\-Documents/\-Securics/squirrel\-\_\-pipeline/jni/onevset\-S\-V\-M/svm.\-cpp}}
}
...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$class T $>$ }\\static T \hyperlink{svm_8cpp_a348440c5435269ac7c60d2e2d8916f48}{min} (T \hyperlink{_2svm-predict_8cpp_a9a5b72a4065074cac5da07efb80a1e79}{x}, T y)
\item 
{\footnotesize template$<$class T $>$ }\\static T \hyperlink{svm_8cpp_a7cba98555a7346b01e4cc06205527d8a}{max} (T \hyperlink{_2svm-predict_8cpp_a9a5b72a4065074cac5da07efb80a1e79}{x}, T y)
\item 
{\footnotesize template$<$class T $>$ }\\static void \hyperlink{svm_8cpp_a91e77fa16b1c9bbbf90f2eea392997b1}{swap} (T \&\hyperlink{_2svm-predict_8cpp_a9a5b72a4065074cac5da07efb80a1e79}{x}, T \&y)
\item 
...
\item 
static void \hyperlink{svm_8cpp_a11814ad6e8976823b61af65e6e36ca1a}{solve\-\_\-c\-\_\-svc} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param}, double $\ast$alpha, \hyperlink{struct_solver_1_1_solution_info}{Solver\-::\-Solution\-Info} $\ast$si, double Cp, double Cn)
\item 
static void \hyperlink{svm_8cpp_a221d17018ed0cd7f218523dbbb9aab4d}{solve\-\_\-nu\-\_\-svc} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param}, double $\ast$alpha, \hyperlink{struct_solver_1_1_solution_info}{Solver\-::\-Solution\-Info} $\ast$si)
\item 
static void \hyperlink{svm_8cpp_a7a8a956d5b08b55756ceaaf63a5d2a87}{solve\-\_\-one\-\_\-class} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param}, double $\ast$alpha, \hyperlink{struct_solver_1_1_solution_info}{Solver\-::\-Solution\-Info} $\ast$si)
\item 
static void \hyperlink{svm_8cpp_a57df27962e3c80e9c2de6c3163850c79}{solve\-\_\-epsilon\-\_\-svr} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param}, double $\ast$alpha, \hyperlink{struct_solver_1_1_solution_info}{Solver\-::\-Solution\-Info} $\ast$si)
\item 
static void \hyperlink{svm_8cpp_add71d0d022422b58f690572f521f0f78}{solve\-\_\-nu\-\_\-svr} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param}, double $\ast$alpha, \hyperlink{struct_solver_1_1_solution_info}{Solver\-::\-Solution\-Info} $\ast$si)
\item 
static \hyperlink{structdecision__function}{decision\-\_\-function} \hyperlink{svm_8cpp_a402bb8c57abf732699dce636892faca7}{svm\-\_\-train\-\_\-one} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param}, double Cp, double Cn)
\item 
...
\item 
static void \hyperlink{svm_8cpp_ae862a4ec5aef90b7ded1cd2a602271f6}{svm\-\_\-binary\-\_\-svc\-\_\-probability} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param}, double Cp, double Cn, double \&prob\-A, double \&prob\-B)
\item 
static double \hyperlink{svm_8cpp_a18e6f0da08035830a3f53829c3b26508}{svm\-\_\-svr\-\_\-probability} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param})
\item 
static void \hyperlink{svm_8cpp_a2b0ace14a7145bfefeded6747d596c09}{svm\-\_\-group\-\_\-classes} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, int $\ast$nr\-\_\-class\-\_\-ret, int $\ast$$\ast$label\-\_\-ret, int $\ast$$\ast$start\-\_\-ret, int $\ast$$\ast$count\-\_\-ret, int $\ast$perm)
\item 
\hyperlink{structsvm__model}{svm\-\_\-model} $\ast$ \hyperlink{svm_8cpp_ae6e4f84556602fab57ec5a330514b613}{svm\-\_\-train} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param})
\item 
void \hyperlink{svm_8cpp_a3f5a9c2ab91444d122c461511af9efd2}{svm\-\_\-cross\-\_\-validation} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param}, int \hyperlink{_2svm-train_8cpp_a8e8ea59d1060e411ced9b25867c66651}{nr\-\_\-fold}, double $\ast$target)
\item 
int \hyperlink{svm_8cpp_a28e647915c662f2862abadb987784875}{svm\-\_\-get\-\_\-svm\-\_\-type} (const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model})
\item 
int \hyperlink{svm_8cpp_a187f866fb5372371ad53090c691d8528}{svm\-\_\-get\-\_\-nr\-\_\-class} (const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model})
\item 
void \hyperlink{svm_8cpp_a0256f035fcd831cc9627d7da8657f65c}{svm\-\_\-get\-\_\-labels} (const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model}, int $\ast$label)
\item 
double \hyperlink{svm_8cpp_a40c2f7a0d7e827b1b987959d2e847844}{svm\-\_\-get\-\_\-svr\-\_\-probability} (const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model})
\item 
...
\item 
double \hyperlink{svm_8cpp_a8c50fdaace093b4aafd6ea600c26b3e2}{svm\-\_\-predict\-\_\-values\-\_\-extended} (const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model}, const \hyperlink{structsvm__node}{svm\-\_\-node} $\ast$\hyperlink{_2svm-predict_8cpp_a9a5b72a4065074cac5da07efb80a1e79}{x}, double $\ast$\&dec\-\_\-values, double $\ast$$\ast$\&scores, int $\ast$\&vote)
\item 
double \hyperlink{svm_8cpp_a1e5816ec29e6c51bc3daeab47cb7e8ef}{svm\-\_\-predict} (const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model}, const \hyperlink{structsvm__node}{svm\-\_\-node} $\ast$\hyperlink{_2svm-predict_8cpp_a9a5b72a4065074cac5da07efb80a1e79}{x})
\item 
double \hyperlink{svm_8cpp_aa6d064a6d798791d1a8d5cc04ce01df5}{svm\-\_\-predict\-\_\-extended} (const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model}, const \hyperlink{structsvm__node}{svm\-\_\-node} $\ast$\hyperlink{_2svm-predict_8cpp_a9a5b72a4065074cac5da07efb80a1e79}{x}, double $\ast$$\ast$\&scores, int $\ast$\&vote)
\item 
...
\item 
int \hyperlink{svm_8cpp_af5b82bcc256ba9d6034d94f28d3c8512}{svm\-\_\-save\-\_\-model} (const char $\ast$model\-\_\-file\-\_\-name, const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model})
\item 
...
\item 
void \hyperlink{svm_8cpp_a192f7f718da0b288dacc446d72b5a77a}{svm\-\_\-destroy\-\_\-param} (\hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param})
\item 
const char $\ast$ \hyperlink{svm_8cpp_a73fd8a0ae428e25666c89c1e29274984}{svm\-\_\-check\-\_\-parameter} (const \hyperlink{structsvm__problem}{svm\-\_\-problem} $\ast$\hyperlink{_2svm-train_8cpp_a3d3cd08abb1a582bcbb3095eb03ed0d6}{prob}, const \hyperlink{structsvm__parameter}{svm\-\_\-parameter} $\ast$\hyperlink{_2svm-train_8cpp_abef2e39cc4fa6cc6870dddf9afa2cfad}{param})
\item 
int \hyperlink{svm_8cpp_a15f0af9b6487b426e68b467f1949e975}{svm\-\_\-check\-\_\-probability\-\_\-model} (const \hyperlink{structsvm__model}{svm\-\_\-model} $\ast$\hyperlink{_2svm-predict_8cpp_a50c87b127b14787341e9630f4f5c700a}{model})
\item 
...
\begin{DoxyCompactItemize}
\item 
int \hyperlink{svm_8cpp_a9ba41253b462f42e64917cc38e0f2cc7}{libsvm\-\_\-version} = \hyperlink{_2svm_8h_ac7f5361b69ddd196a885f142b3c1d261}{L\-I\-B\-S\-V\-M\-\_\-\-V\-E\-R\-S\-I\-O\-N}
\item 
static void($\ast$ \hyperlink{svm_8cpp_a9a4e68dbfe2b342ff45c12c638ec39cb}{svm\-\_\-print\-\_\-string} )(const char $\ast$) = \&\hyperlink{_2svm_8cpp_a4edee28127eebfbcdab94b75c57341c5}{print\-\_\-string\-\_\-stdout}
\item 
...
Definition at line 2831 of file svm.\-cpp.
...
Definition at line 2934 of file svm.\-cpp.
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [read]}}}\label{svm_8cpp_a3e6ebc4bfaa5017e9336a28d8841097c}
...
\hypertarget{svm_8cpp_aa6d064a6d798791d1a8d5cc04ce01df5}{\index{svm.\-cpp@{svm.\-cpp}!svm\-\_\-predict\-\_\-extended@{svm\-\_\-predict\-\_\-extended}}
...
\item[{int $\ast$\&}]{vote}
\end{DoxyParamCaption}
)}}\label{svm_8cpp_aa6d064a6d798791d1a8d5cc04ce01df5}
...
\hypertarget{svm_8cpp_a8c50fdaace093b4aafd6ea600c26b3e2}{\index{svm.\-cpp@{svm.\-cpp}!svm\-\_\-predict\-\_\-values\-\_\-extended@{svm\-\_\-predict\-\_\-values\-\_\-extended}}
...
\item[{int $\ast$\&}]{vote}
\end{DoxyParamCaption}
)}}\label{svm_8cpp_a8c50fdaace093b4aafd6ea600c26b3e2}
...
Definition at line 2473 of file svm.\-cpp.
